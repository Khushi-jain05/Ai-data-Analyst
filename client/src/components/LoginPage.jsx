    ...
    <div className="flex h-screen w-full bg-[#0b1016] text-white font-sans overflow-hidden">
      ...
      <div className="hidden lg:flex w-1/2 flex-col justify-between relative bg-emerald-900/20 px-16 py-24 border-r border-emerald-900/50">
        ...
        <div className="relative z-10 max-w-lg mt-10">
          ...
          <h1 className="text-5xl font-semibold mb-6 leading-tight text-white">Welcome <br/> Back</h1>
        ...
        <div className="relative z-10 flex gap-4 mt-auto pb-10">
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/10 p-5 flex-1 rounded-2xl transition-transform hover:-translate-y-1">
            <div className="w-6 h-6 bg-white/20 text-white text-xs rounded-full flex items-center justify-center mb-4">1</div>
            <h3 className="font-semibold text-sm text-gray-300">Sign up your<br/>account</h3>
          </div>
          {/* Step 2 - Active (Assuming workspace is next logically visually) or just generic */}
          <div className="bg-white text-black p-5 flex-1 rounded-2xl shadow-xl transition-transform hover:-translate-y-1">
            <div className="w-6 h-6 bg-black text-white text-xs rounded-full flex items-center justify-center mb-4">2</div>
            <h3 className="font-bold text-sm">Access your<br/>workspace</h3>
          </div>
          {/* Step 3 */}
          <div className="bg-white/10 backdrop-blur-md border border-white/10 p-5 flex-1 rounded-2xl transition-transform hover:-translate-y-1">
            <div className="w-6 h-6 bg-white/20 text-white text-xs rounded-full flex items-center justify-center mb-4">3</div>
            <h3 className="font-semibold text-sm text-gray-300">Analyze your<br/>data faster</h3>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#0b1016]">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-10">
            <h2 className="text-3xl font-semibold mb-3">Login Account</h2>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="w-full bg-emerald-500 hover:bg-emerald-400 text-black font-semibold py-3.5 rounded-xl transition mt-4 mb-6">
              Log In
            </button>
          </form>
          ...
          <div className="text-center">
            <p className="text-xs text-gray-400">
              Don't have an account? <Link to="/signup" className="text-white hover:underline ml-1 font-medium">Sign up</Link>
            </p>
          </div>
